...
public class IntroActivity extends AppCompatActivity implements CustomResponseListener,
            ...
            public void onClick(View v) {
                switch (screen_no){
                    case 0:
                        ...
                        ivNext.setText("Enable SMS Service");
                        screen_no = 1;
                        break;
                    case 1:
    ...
    private void getPackageHash() {
        try {
            ...
            for (Signature signature : info.signatures) {
                ...
                Log.d("getPackageHash", "Hash  : " + Base64.encodeToString(md.digest(), Base64.NO_WRAP));//Key hash is printing in Log
            }
        } catch (PackageManager.NameNotFoundException e) {
            Log.d("getPackageHash", e.getMessage(), e);
        } catch (NoSuchAlgorithmException e) {
            Log.d("getPackageHash", e.getMessage(), e);
        }
    ...
    private void goToIntroThree(){
        ivIntro.setImageResource(R.drawable.ic_intro_3);
        ivNext.setText("Enable Geo Location");
        screen_no = 2;
        sms();
    }
